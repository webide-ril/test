sap.ui.define([
	...
	return {
		 ...
		 * }
		 *
		 * @param {object}[oOptions.config]  see {@link sap.ui.model.odata.v2.ODataModel#constructor.mParameters} it is the exact same object,
		 * the metadataUrlParams are enrichted by the oOptions.urlParametersToPassOn
		...
		createODataModel: function(oOptions) {
			...
			if (!oOptions.url) {
				jQuery.sap.log.error("Please provide a url when you want to create an ODataModel",
					"nw/epm/refapps/ext/po/apv.model.models.createODataModel");
				return null;
			}
